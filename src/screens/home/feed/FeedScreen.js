...
export default function FeedScreen({ navigation, route }) {
    ...
    // const salesInfo = [
    //     {
    //         imgPath: require('../../../../assets/pngs/home/PostImage.png'), text: 'Дополнительная скидка 5% и презент', 
    //     },
    //     {
    ...
    return <View style={Styles.container}>
        <ScrollView style={{ paddingHorizontal: 20 }}>
            {data.map((item, i) => <PostItem postInfo={item} key={i} onPressItem={() => navigation.navigate('PostSingleScreen', { title: 'Сильным и смелым! Подарки на 23 февраля', itemInfo: item.news })} />)}
        </ScrollView>
    </View>
}
